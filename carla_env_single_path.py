...
from reward.reward import reward_func1, reward_func2, reward_fn_following_lane, reward_fn_waypoint, reward_fn_pedestrian
from reward.reward_func_new import reward_with_risk_factor
import subprocess
...
class CarlaEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # REWARD FUNCTION SELECTION BASED ON THE TIME_STEP
        ...
        info = {
                ...
                'gpu_usage' : gpu_usage,
                'max_distance' : self.max_distance_covered
            }
